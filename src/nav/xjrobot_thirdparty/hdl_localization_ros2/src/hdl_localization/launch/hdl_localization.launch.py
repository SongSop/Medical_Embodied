...
def _launch_setup(context, *args, **kwargs):
    ...
    publish_base_to_lidar_tf = LaunchConfiguration('publish_base_to_lidar_tf')
    ...
    return [
        ...
        Node(
            ...
            condition=IfCondition(publish_base_to_lidar_tf),
        ),
            ...
            composable_node_descriptions=[
                ...
                ComposableNode(
                    ...
                    parameters=[{
                        ...
                        'log_output_frequency_hz': ParameterValue(log_output_frequency_hz, value_type=float),
                    }],
                ),
            ],
            output='screen',
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'publish_base_to_lidar_tf',
            default_value='true',
            description='Publish static transform odom_child_frame_id -> lidar_frame_id.',
        ),
        DeclareLaunchArgument(
            'globalmap_pcd',
        ...
        DeclareLaunchArgument(
            'log_output_frequency_hz',
            default_value='1.0',
            description='Throttle repeated hdl_localization logs to this frequency in Hz. Set <=0 to effectively disable them.',
        ),
        DeclareLaunchArgument(
